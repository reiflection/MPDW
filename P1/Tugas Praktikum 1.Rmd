...
data.gab2 <- cbind(aktual = c(rma_train.ts,rep(NA,25)), pemulusan1 = c(rice.sma,rep(NA,25)),pemulusan2 = c(rice.dma, rep(NA,25)),At = c(At, rep(NA,25)), Bt = c(Bt,rep(NA,25)),ramalan = c(rice.ramal.dma, f[-1]))
data.gab2
```
